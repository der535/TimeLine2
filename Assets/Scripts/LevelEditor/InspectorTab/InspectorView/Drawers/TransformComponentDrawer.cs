...
namespace TimeLine.CustomInspector.UI.Drawers
{
    public class TransformComponentDrawer : IComponentDrawer
    {
        ...
        public void Draw(Entity target)
        {
            ...
            {
                LocalTransform transform2 = manager.GetComponentData<LocalTransform>(target);
                _keyframeCreator.CreateKeyframeCommand(new EntityYPositionData(transform2.Position.y), target, "Position/Y",
                    Color.blue,
                    "Transform", ComponentNames.Transform);
            };
            ...
            {
                PositionData positionData = manager.GetComponentData<PositionData>(target);
                CommandHistory.AddCommand(new PositionChangedCommand("", new float2(positionData.Position.x, newValue), this, _trackObjectStorage.GetTrackObjectData(target), _trackObjectStorage), true);
            ...
            Action createKeyFrameRotationZ = () =>
            {
                ...
                _keyframeCreator.CreateKeyframeCommand(new EntityZRotationData(rotationData2.RotateZ),
                    target, "Rotation/z",
                    Color.green,
                    "Transform", ComponentNames.Transform);
            };
            ...
            {
                CommandHistory.AddCommand(new RotationChangedCommand(newValue, this, _trackObjectStorage.GetTrackObjectData(target), _trackObjectStorage, ""), true);
            ...
            Action createKeyFrameScaleX = () =>
            {
                ...
                _keyframeCreator.CreateKeyframeCommand(new EntityXScaleData(nonUniformScale2.x), target, "Scale/X",
                    Color.red,
                    "Transform", ComponentNames.Transform);
            };
            ...
            {
                var scale = manager.GetComponentData<PostTransformMatrix>(target).Value.Scale();
                CommandHistory.AddCommand(new ScaleChangedCommand(new float2(newValue, scale.y), this, _trackObjectStorage.GetTrackObjectData(target), _trackObjectStorage, ""), true);
            ...
            Action createKeyFrameScaleY = () =>
            {
                ...
                float3 nonUniformScale2 =
                    new float3(postMatrix2.Value.c0.x, postMatrix2.Value.c1.y, postMatrix2.Value.c2.z);
                _keyframeCreator.CreateKeyframeCommand(new EntityYScaleData(nonUniformScale2.y), target, "Scale/Y",
                    Color.blue,
                    "Transform", ComponentNames.Transform);
            };
            ...
            {
                var scale = manager.GetComponentData<PostTransformMatrix>(target).Value.Scale();
                CommandHistory.AddCommand(new ScaleChangedCommand(new float2(scale.x, newValue), this, _trackObjectStorage.GetTrackObjectData(target), _trackObjectStorage, ""), true);
