    ...
    public class TransformComponentDrawer : IComponentDrawer
    {
        ...
        public void Draw(Component component, GameObject target)
        {
            ...
            if (component is TransformComponent tc)
            {
                ...
                // Позиция
                _customInspectorDrawer.CreateFloatField(tc.XPosition, link.trackObjectPacket,
                ...
                _customInspectorDrawer.CreateFloatField(tc.YPosition, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
                ...
                _customInspectorDrawer.CreateFloatField(tc.XPositionOffset, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, null);
                _customInspectorDrawer.CreateFloatField(tc.YPositionOffset, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, null);

                _customInspectorDrawer.AddSpace(30);

                // Ротация
                _customInspectorDrawer.CreateFloatField(tc.XRotation, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
                ...
                _customInspectorDrawer.CreateFloatField(tc.YRotation, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
                ...
                _customInspectorDrawer.CreateFloatField(tc.ZRotation, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
                ...
                // Масштаб
                _customInspectorDrawer.CreateFloatField(tc.XScale, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
                        tc.CreateKeyframeManual(new XScaleData(tc.XScale.Value), tc.XScale));
                _customInspectorDrawer.CreateBoolField(tc.XScaleActive);

                _customInspectorDrawer.CreateFloatField(tc.YScale, link.trackObjectPacket,
                    (BaseParameterComponent)component, id, () =>
