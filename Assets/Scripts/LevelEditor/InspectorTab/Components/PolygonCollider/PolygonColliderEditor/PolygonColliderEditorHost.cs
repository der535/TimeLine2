...
namespace TimeLine.EdgeColliderEditor
{
    public class PolygonColliderEditorHost : MonoBehaviour
    {
        ...
        private void Start()
        {
            _gameEventBus.SubscribeTo<EditorSceneCameraUpdateViewEvent>(UpdateView);
           
        }

        private void UpdateView(ref EditorSceneCameraUpdateViewEvent data)
        {
            ...
            GameObject edgeColliderObject)
        {
            ...
            _view.OutlineRenderer.sortingOrder = 99;
