...
namespace TimeLine
{
    public class CircleCollider2DComponent : BaseParameterComponent
    {
        ...
        {
            _eventBus = eventBus;
            _circleCollider2DOutline = container.InstantiatePrefab(collidersPrefab.CircleCollider2DPrefab).GetComponent<CircleCollider2DOutline>();
            
            _isActiveChanged = (bool data) =>
            {
                _circleCollider2DOutline.CircleCollider.enabled = isActive.Value && data;
            };
            ...
            transformComponent.ChangeTransform += _circleCollider2DOutline.UpdateOutline;
            ...
            _circleCollider2DOutline.Setup(_activeObjectControllerComponent, transformComponent);
        }
