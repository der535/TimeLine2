...
//                     Quaternion.Euler(val, transform.localRotation.y, transform.localRotation.z));
//
//             Bind<float, FloatParameter>(YRotation,
//                 val => new YRotationData(val),
//                 val => transform.localRotation =
//                     Quaternion.Euler(transform.localRotation.x, val, transform.localRotation.z));
//
...
//             YPosition.OnValueChanged += ChangeTransform;
//             XRotation.OnValueChanged += ChangeTransform;
//             YRotation.OnValueChanged += ChangeTransform;
...
//         {
//             TransformComponentStorage.RemoveComponent(this);
//             
