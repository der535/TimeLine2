...
namespace TimeLine
{
    public class PlayerMoveScale : MonoBehaviour
    {
        ...
        [Inject]
        private void Construct(ActionMap actionMap, PlayerComponents playerComponents, GameEventBus gameEventBus, PlayerInputView playerInputView)
        {
        ...
        public void Update()
        {
            ...
            if (newMoveInput.x != 0 || newMoveInput.y != 0)
            {
