...
namespace TimeLine
{
    public class Main : MonoBehaviour
    {
        ...
        public double TicksCurrentTime()
        {
            if (firstPlayaing)
            {
                return _timeLineConverter.SecondsToTicks(_currentTimeMarkerRenderer.GetTime());
            }
            else
            {
        ...
        private void Construct(
            ...
            TimeLineConverter timeLineConverter, CurrentTimeMarkerRenderer currentTimeMarkerRenderer)
        {
