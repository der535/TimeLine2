...
{
    /// <summary>
    /// Скрип который собирает все скрипты которые имеют интерфейс InitializedComponentData и когда объект
    /// должен включится у него вызываеться метод инициализации
    /// </summary>
