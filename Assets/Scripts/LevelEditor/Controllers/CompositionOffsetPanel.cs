...
//                         xOffset.text = compositionOffset.XOffset.Value.ToString(CultureInfo.InvariantCulture);
//                         yOffset.text = compositionOffset.YOffset.Value.ToString(CultureInfo.InvariantCulture);
