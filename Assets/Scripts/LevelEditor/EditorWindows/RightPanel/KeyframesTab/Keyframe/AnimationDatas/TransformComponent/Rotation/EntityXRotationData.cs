...
{
    [System.Serializable]
    public class EntityXRotationData : EntityAnimationData
    {
        public EntityXRotationData(float value)
        {
        ...
        {
            return new EntityXRotationData((float)Logic.GetValue());
        }
        ...
        {
            return nameof(EntityXRotationData);
        }
        ...
        {
            if (other is not EntityXRotationData otherPos)
                throw new System.ArgumentException("Interpolation requires another xrotationData.");
