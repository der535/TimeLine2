...
namespace TimeLine.LevelEditor.ActionHistory.Commands
{
    ...
    public class FloatParameterChangeCommand : ICommand
    {
        ...
        public FloatParameterChangeCommand(TrackObjectStorage objectStorage, Entity targetEntity, string description,
            string objectID, float valueBeforeChange, float valueAfterChange)
        {
            _targetEntity = _argetEntity;
        ...
        public void Execute()
        {
            ...
            _targetEntity.Value = _valueAfterChange;
        }
