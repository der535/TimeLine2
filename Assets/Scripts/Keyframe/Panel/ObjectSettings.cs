...
namespace TimeLine
{
    public class ObjectSettings : MonoBehaviour
    {
        ...
        private void OnMouseDown()
        {
            ...
            // _settingsPanel.Select(gameObject.transform, AddKeyframe);
            print("Select");
        }
        ...
        //         _keyframeTrackStorage.AddTrack(node, new Track(gameObject, gameObject.name), trackObjectData.trackObject);
        //     
        //     _keyframeTrackStorage.AddKeyframe(node, _main.CurrentTime - trackObjectData.trackObject.StartTime, new PositionData(gameObject.transform.position));
        // }
    }
